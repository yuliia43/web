...
if ($rows < 3 || $cols < 3) 
{ 
	mysqli_query($connection, "INSERT INTO `incorrect`(`tables`,`rows`, `cols`) VALUES ('3','$rows','$cols')");
print "<br /> <b> ERROR: </b> Input is incorrect. Not able to build the table. The number of the rows and columns should be not less than 2"; 
	...
	mysqli_query($connection, "INSERT INTO `correct`(`tables`,`rows`, `cols`) VALUES ('3','$rows','$cols')");
require 'tbl3.php';
}
